...
export const config: IConfig = {
  ...
  UNISWAP_V2_FACTORY_ADDRESS: process.env.UNISWAP_V2_FACTORY!,
  UNISWAP_V2_ROUTER: process.env.UNISWAP_V2_ROUTER!,
  UNISWAP_V3_FACTORY_ADDRESS: process.env.UNISWAP_V3_FACTORY!,
  UNISWAP_V4_POOL_MANAGER_ADDRESS: process.env.UNISWAP_V4_POOL_MANAGER!,
